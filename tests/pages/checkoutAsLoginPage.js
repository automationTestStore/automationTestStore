...
module.exports = class checkoutAsLoginPage {
    constructor(page){
           this.page = page
           this.loginOrRegisterButton = page.locator("//a[text()='Login or register']")
    ...
    async sucessMessageValidation(){
        await expect(this.sucessMessage).toContainText('Your Order Has Been Processed!')
    }
}

//cmd /c "set PWDEBUG=1 && npx cucumber-js tests/features/checkout-as-login.feature --tags @checkout"
//npx cucumber-js E:\automationTestStore\tests\features\checkout-as-login.feature --tags "@checkout"  